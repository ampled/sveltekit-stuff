...
export function RippleStart(e, options = {}) {
    ...
    // Parent element
    const target = (isTouchEvent(e) ? e.touches[0].target : e.currentTarget);
    ...
    if (opts.centered) {
        ...
        const distY = isTouchEvent(e) ? e.touches[0].clientY : e.clientY;
        const distX = isTouchEvent(e) ? e.touches[0].clientX : e.clientX;
